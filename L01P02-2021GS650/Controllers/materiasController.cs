...
using L01P02_2021GS650.Models;

namespace L01P02_2021GS650.Controllers
{
    public class materiasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,materia,unidades_valorativas,estados")] materias materias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,materia,unidades_valorativas,estados")] materias materias)
        {
            if (id != materias.id)
            {
                return NotFound();
